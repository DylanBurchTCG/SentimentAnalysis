...
# Optional cleanup function, currently disabled
...
custom_stopwords = STOPWORDS.union({
    ...
    # Some additional filler or common words
...
def index():
    ...
    mood_30, wc_30, top_words_30, _ = compute_mood_score_for_period_filtered(30, df_reviews, timestamp)
    mood_60, wc_60, top_words_60, _ = compute_mood_score_for_period_filtered(60, df_reviews, timestamp)
    mood_90, wc_90, top_words_90, _ = compute_mood_score_for_period_filtered(90, df_reviews, timestamp)
...
def filter_data():
    ...
    mood_30, wc_30, top_words_30, _ = compute_mood_score_for_period_filtered(30, filtered_df, timestamp)
    mood_60, wc_60, top_words_60, _ = compute_mood_score_for_period_filtered(60, filtered_df, timestamp)
    mood_90, wc_90, top_words_90, _ = compute_mood_score_for_period_filtered(90, filtered_df, timestamp)
